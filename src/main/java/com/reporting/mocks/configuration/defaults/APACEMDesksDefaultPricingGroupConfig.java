...
public class APACEMDesksDefaultPricingGroupConfig extends PricingGroupConfig {
    protected final int startingTradeCount = 50000;
    protected final int newTradeStart = 0;
    protected final int newTradePeriodicity = 8 * 1000;        // number of milliseconds between new tcnTrades (default: 10s)
